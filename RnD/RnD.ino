...
void loop() {
  ...
  Serial.print("SYSTEM IN ACTION");
  Serial.println("Agro-Tech: Integrating Technology in Agriculture!");
  

  if (redPW > 200)
  {
    Serial.println("Apple condition is Good!");
    Serial.println("Sending for UV and Sanitation!");     
    sort_servo.write(179);
  } else if (greenPW > 200) {
    Serial.println("Apple condition is Bad!");
    Serial.println("Sending for Decomposing!");    
    sort_servo.write(0);
  }
